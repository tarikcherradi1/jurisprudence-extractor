...
| MarocDroit - recherche complète | secondaire | 8 | 66 | 5 001 959 |
...
- Markdown courant : `gs://gti-secure-vault-2026/jurisprudence/derived/md/v2/`.
- Rapports courants : `gs://gti-secure-vault-2026/jurisprudence/derived/extraction/v2/`.
...
- Quatorze PDF ont été transformés en Markdown : 1 353 pages physiques et 1 737 089 caractères non
  blancs. Deux scans ont nécessité l'OCR et sont marqués pour revue humaine.
- La version `v2` étend ce signal à toutes les republications secondaires ; `v1` est conservée
  comme dérivé historique immuable.
